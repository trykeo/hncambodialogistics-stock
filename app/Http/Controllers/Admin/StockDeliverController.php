...
class StockDeliverController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->messages != null)
        {
            ...
            return view('admin.stockDeliver.index', compact('messages', 'groups', 'locations'));
        }

        return view('admin.stockDeliver.index', compact('groups', 'locations'));
    }
    ...
    public function show(Product $stockComplete)
    {
        ...
        return view('admin.stockDeliver.show', compact('product'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.stockDeliver.create', compact('out_locations', 'user_locations', 'products'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // ];
        // , compact('messages')
        return redirect()->route('admin.stock-deliver.index');
    }
    ...
    public function edit(Product $stockComplete)
    {
        ...
        return view('admin.stockDeliver.edit', compact('product'));
    }
