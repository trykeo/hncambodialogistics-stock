...
class StockPickupController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->messages != null)
        {
            ...
            return view('admin.stockPickup.index', compact('messages', 'groups', 'locations'));
        }

        return view('admin.stockPickup.index', compact('groups', 'locations'));
    }
    ...
    public function show(Product $stockComplete)
    {
        ...
        return view('admin.stockPickup.show', compact('product'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.stockPickup.create', compact('out_locations', 'user_locations', 'products'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // ];
        // , compact('messages')
        return redirect()->route('admin.stock-pickup.index');
    }
    ...
    public function edit(Product $stockComplete)
    {
        ...
        return view('admin.stockPickup.edit', compact('product'));
    }
