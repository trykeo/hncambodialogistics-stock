...
class KhStockInController extends Controller
{
    public function index(Request $request)
    {
        // abort_if(Gate::denies('bkk_stock_in_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');
        ...
        if ($request->messages != null)
        {
            ...
            return view('admin.khStockIns.index', compact('messages', 'groups', 'locations'));
        }

        return view('admin.khStockIns.index', compact('groups', 'locations'));
    }
    ...
    public function create()
    {
        ...
        $in_locations = Location::where('country', 'cambodia')->get()->pluck('full_name', 'id');
        ...
        return view('admin.khStockIns.create', compact('in_locations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // ];
        // , compact('messages')
        return redirect()->route('admin.kh-stock-ins.index');
    }
    ...
    public function show(Product $stockIn)
    {
        ...
        return view('admin.khStockIns.show', compact('product'));
    }
    ...
    public function edit(Product $stockIn)
    {
        ...
        return view('admin.khStockIns.edit', compact('product'));
    }
    ...
    public function grouping()
    {
        ...
        return view('admin.khStockIns.group', compact('user_locations', 'products'));
    }
    ...
    public function storeGrouping(Request $request)
    {
        ...
        if ($productQuery->count() == 0)
        {
            ...
            return redirect()->route('admin.kh-stock-ins.index', compact('messages'));
        }
