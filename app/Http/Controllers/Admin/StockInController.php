...
class StockInController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->messages != null)
        {
            ...
            return view('admin.stockIns.index', compact('messages', 'groups', 'locations'));
        }

        return view('admin.stockIns.index', compact('groups', 'locations'));
    }
    ...
    public function create()
    {
        ...
        $in_locations = Location::get()->pluck('full_name', 'id');
        ...
        return view('admin.stockIns.create', compact('in_locations'));
    }
    ...
    public function show(Product $stockIn)
    {
        ...
        return view('admin.stockIns.show', compact('product'));
    }
    ...
    public function edit(Product $stockIn)
    {
        ...
        return view('admin.stockIns.edit', compact('product'));
    }
    ...
    public function grouping()
    {
        ...
        return view('admin.stockIns.group', compact('user_locations', 'products'));
    }
    ...
    public function storeGrouping(Request $request)
    {
        ...
        if ($productQuery->count() == 0)
        {
            ...
            return redirect()->route('admin.stock-ins.index', compact('messages'));
        }
