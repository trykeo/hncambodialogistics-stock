...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12" id="actions">
        <a class="btn btn-success" id="kh-stock-in" href="#{{ route('admin.stock-ins.create') }}">
...
<script>
  ...
  let stockInButtonTrans = 'KH Stock In'
  let stockInButton = {
    text: stockInButtonTrans,
  ...
  dtButtons.push(stockInButton)
  $("#actions").push(stockInButton)
//   $('#kh-stock-in').DataTable(stockInButton)
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.pending-kh-stock-ins.index') }}",
    columns: [
