...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        <a class="btn btn-success" href="{{ route('admin.stock-deliver.create') }}">
            {{-- <i class="fa-fw fas fa-check mr-2"></i> --}}
            <i class="fa-fw fas fa-truck-loading mr-2"></i>
            Stock Deliver
        </a>
    </div>
</div>
...
@can('stock_complete_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.stock-deliver.massDestroy') }}",
...
@endcan
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.stock-deliver.index') }}",
    columns: [
