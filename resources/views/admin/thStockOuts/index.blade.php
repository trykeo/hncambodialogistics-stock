...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        <a class="btn btn-success" href="{{ route('admin.th-stock-outs.create') }}">
            <i class="fa-fw fas fa-truck mr-2"></i>
            TH Stock Out
        </a>
    </div>
</div>
...
@can('stock_out_delete')
  let deleteButtonTrans = '{{ trans('global.datatables.delete') }}'
  let deleteButton = {
    text: deleteButtonTrans,
    url: "{{ route('admin.th-stock-outs.massDestroy') }}",
...
@endcan
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.th-stock-outs.index') }}",
    columns: [
