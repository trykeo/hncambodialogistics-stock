    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-alerts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alter_title') ? 'is-invalid' : '' }}" type="text" name="alter_title" id="alter_title" value="{{ old('alter_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('view_at') ? 'is-invalid' : '' }}" type="text" name="view_at" id="view_at" value="{{ old('view_at') }}">
