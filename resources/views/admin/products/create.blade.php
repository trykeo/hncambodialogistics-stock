    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bar_code') ? 'is-invalid' : '' }}" type="text" name="bar_code" id="bar_code" value="{{ old('bar_code', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('deliver_at') ? 'is-invalid' : '' }}" type="text" name="deliver_at" id="deliver_at" value="{{ old('deliver_at') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_group') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_group" id="is_group" value="1" {{ old('is_group', 0) == 1 ? 'checked' : '' }}>
